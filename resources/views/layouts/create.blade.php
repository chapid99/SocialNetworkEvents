...
<html>
    <head>
        ...
        <link href="../../classy/assets/libs/prettify/github.css" rel="stylesheet" />
                ...
                <link href="../../classy/assets/libs/bootstrap-select/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
                <link href="../../classy/assets/libs/summernote/summernote.css" rel="stylesheet" type="text/css" />
        ...
        <link rel="apple-touch-icon" sizes="76x76" href="../../classy/../../classy/assets/img/apple-touch-icon-76x76.png" />
                        ...
                        <ul class="dropdown-menu dropdown-message">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="../../classy/images/users/chat/2.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li class="unread">
                                <a href="#" class="clearfix">
                                    <img src="../../classy/images/users/chat/1.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <img src="../../classy/images/users/chat/3.jpg" class="xs-avatar ava-dropdown" alt="Avatar">
...
<!-- Top Bar End -->
                        ...
                        <div id="chat-coll" class="panel-collapse collapse in">
                          <div class="panel-body">
                            <ul class="list-unstyled" id="chat-list">
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/1.jpg"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/2.jpg"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/3.jpg"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg">Where is my mind</span></a></li>
                                <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/4.jpg"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
                                <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/5.jpg"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
                                <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/6.jpg"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse in">
                          <div class="panel-body">
                            <ul class="list-unstyled" id="chat-list">
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/1.jpg"></span> <span class="chat-user-name">Dorothy Simons</span><span class="chat-user-msg">I wish I was a bird in the sky</span></a></li>
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/2.jpg"></span> <span class="chat-user-name">John Malkovich</span><span class="chat-user-msg">You were the traitor</span></a></li>
                                <li><a href="javascript:;" class="online"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/3.jpg"></span> <span class="chat-user-name">Jessica Simons</span><span class="chat-user-msg" title="Eminem - The Monster ft. Rihanna"><i class="icon-play"></i> Eminem - The Monster ft. Rihanna</span></a></li>
                                <li><a href="javascript:;" class="away"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/4.jpg"></span> <span class="chat-user-name">Jack Stallman</span><span class="chat-user-msg">Away since 13:32</span></a></li>
                                <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/5.jpg"></span> <span class="chat-user-name">Neil Armstrong</span><span class="chat-user-msg" title="I am flying to the moon and back">I am flying to the moon and back</span></a></li>
                                <li><a href="javascript:;" class="offline"><span class="chat-user-avatar"><img src="../../classy/images/users/chat/6.jpg"></span> <span class="chat-user-name">Hollywood Studios</span><span class="chat-user-msg">Yes he definitely is!</span></a></li>
                            </ul>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class='fa fa-check'></i> TypeUsers</h1>
                </div>
                <!-- Page Heading End-->    
    ...
    <script src="../../classy/../../classy/../../classy/assets/js/init.js"></script>
    <!-- Page Specific JS Libraries -->
    <script src="../../classy/../../classy/assets/libs/bootstrap-select/bootstrap-select.min.js"></script>
    <script src="../../classy/assets/libs/bootstrap-inputmask/inputmask.js"></script>
    <script src="../../classy/assets/libs/summernote/summernote.js"></script>
    <script src="../../classy/assets/js/pages/forms.js"></script>
    </body>
</html>